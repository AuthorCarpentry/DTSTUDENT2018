...
ORCID: Enter your ORCID number here and hyperlink it
...
A sample of the doaj_seal.csv data set is shown below.   The complete data set is available in searchable and broweseable format as Annex 10.1 #annex-table in the Annex section near the end of this document.
...
Annex Table Complete doaj_seal dataset (set target as annex-table)
