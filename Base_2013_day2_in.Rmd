...
A sample of the doaj_seal.csv data set is shown below.  A dynamic table providing the full dataset in browseable, sortable format is provided in the Annex hear the end of this document.
