...
author: "Firstname Lastname, Institution"
...
||> insert link to DOAJ Seal of Approval doaj_seal_logo.png <||
...
ORCID: ||>Insert your ORCID number here and hyperlink it <||

Date of First Version 

||> Enter date from insert_dates.R <||
...
- All original data, code, or reports produced as part of this project are owned by Trieste Polytechnic Institute per its institutional intellectual property policy.
...
A sample of the doaj_seal.csv data set is shown below.   The complete data set is available in searchable and broweseable format in the [Annex section](#annex-table) near the end of this document.
...
6 Journal article | Typeset manuscript | RMarkdown, 9 MB| |
...
Complete doaj_seal dataset {annex-table}

This table is produced using the DT table package by Xie, 2018. 

||> This is where to place insert_DTtable.R <|| 

Principal Investigator's BioSketch

This section is populated dynamically from the author's ORCID profile using the rorcid package by Chamberlain.

||> This is where to place insert_orcid.R <||
...
Xie et al, 2018. blah blah blah  

Tidyverse package, blahblah

rorcid package, blahblahblah

DT Table package, blahblahblah
